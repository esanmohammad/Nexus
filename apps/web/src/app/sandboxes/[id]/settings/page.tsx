  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-semibold text-text-primary mb-2">Extend TTL</h2>
        {sandbox && (
        ...
        <button
          ...
          className="mt-3 px-4 py-2 text-sm bg-accent text-white rounded-xl hover:bg-accent/90 min-h-[44px] transition-colors"
        >
          Extend
        </button>
        {success && (
          <p className="text-sm text-success mt-2">TTL extended!</p>
        )}
      </section>
    </div>
  );
